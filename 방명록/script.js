...
import { query, orderBy, getDocs, deleteDoc, doc } from "https://www.gstatic.com/firebasejs/10.14.0/firebase-firestore.js";
...
btn.addEventListener("click", async function () {
    ...
    if (id == '' || pw == '' || comment == '') { alert("빈 칸에 입력하세요") } else {
